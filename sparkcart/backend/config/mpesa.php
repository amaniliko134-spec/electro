...
return [
    //This is the mpesa environment. Can be sandbox or production
    // Support both MPESA_ENVIRONMENT and MPESA_ENV for compatibility
    'environment' => env('MPESA_ENVIRONMENT', env('MPESA_ENV', 'sandbox')),

    /*-----------------------------------------
        |Enable Mpesa integration in the application
        |------------------------------------------
        */
    ...
    /*-----------------------------------------
        ...
        |------------------------------------------
        */
    // Support both SAFARICOM_PASSKEY and MPESA_PASSKEY
    'passkey' => env('SAFARICOM_PASSKEY', env('MPESA_PASSKEY', 'bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919')),

    /*--------------------------------------------------------------
        |The Lipa na Mpesa Online ShortCode (Paybill Number)
        |-----------------------------------------------------------
    */
    // Support both MPESA_STK_SHORTCODE (package) and MPESA_BUSINESS_SHORTCODE (existing)
    ...
    */
    ...
    'callbacks' => [
        ...
        // Support MPESA_STK_CALLBACKURL (package) and MPESA_CALLBACK_URL
        'callback_url' => env('MPESA_STK_CALLBACKURL', env('MPESA_CALLBACK_URL')),
